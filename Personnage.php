...
abstract class Personnage
{
	...
	const PERSONNAGE_ENSORCELE = 4; // Constante renvoyée par la méthode 'lancerUnSort' (voir classe Magicien) si on veut jeter un sort alors que la magie du magicien est à 0.
	...
	//On indique au personnage qu'il doit recevoir les dégats.
